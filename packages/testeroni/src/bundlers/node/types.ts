...
export type NodeBundleOptions = Pick<SharedBundleOptions, 'workingDir' | 'dependencies' | 'devDependencies' | 'module' | 'skipPackageInstall' | 'keepWorkingFiles'>;
const validKeys = ['workingDir', 'dependencies', 'devDependencies', 'module', 'skipPackageInstall', 'keepWorkingFiles',];
